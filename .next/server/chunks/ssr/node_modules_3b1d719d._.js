...
Read more: https://nextjs.org/docs/messages/invalid-use-server-value`),"__NEXT_ERROR_CODE",{value:"E352",enumerable:!1,configurable:!0})}}Object.defineProperty(c,"__esModule",{value:!0}),Object.defineProperty(c,"ensureServerEntryExports",{enumerable:!0,get:function(){return d}})},85978,a=>{"use strict";a.s(["collectKeylessMetadata",()=>e,"formatMetadataHeaders",()=>g]);var b=a.i(37936);a.i(44721);var c=a.i(5246),d=a.i(13095);async function e(){var a,b,d,e,g,h;let i=await (0,c.headers)();return{nodeVersion:process.version,nextVersion:function(){var a;try{return null!=(a=process.title)?a:"unknown-process-title"}catch{return}}(),npmConfigUserAgent:process.env.npm_config_user_agent,userAgent:null!=(a=i.get("User-Agent"))?a:"unknown user-agent",port:process.env.PORT,host:null!=(b=i.get("host"))?b:"unknown host",xPort:null!=(d=i.get("x-forwarded-port"))?d:"unknown x-forwarded-port",xHost:null!=(e=i.get("x-forwarded-host"))?e:"unknown x-forwarded-host",xProtocol:null!=(g=i.get("x-forwarded-proto"))?g:"unknown x-forwarded-proto",xClerkAuthStatus:null!=(h=i.get("x-clerk-auth-status"))?h:"unknown x-clerk-auth-status",isCI:function(){let a=new Set(["","false","0","no"]);return f.some(b=>{let c=process.env[b];if(void 0===c)return!1;let d=c.trim().toLowerCase();return!a.has(d)})}()}}let f=["CI","CONTINUOUS_INTEGRATION","BUILD_NUMBER","BUILD_ID","BUILDKITE","CIRCLECI","GITHUB_ACTIONS","GITLAB_CI","JENKINS_URL","TRAVIS","APPVEYOR","WERCKER","DRONE","CODESHIP","SEMAPHORE","SHIPPABLE","TEAMCITY_VERSION","BAMBOO_BUILDKEY","GO_PIPELINE_NAME","TF_BUILD","SYSTEM_TEAMFOUNDATIONCOLLECTIONURI","BITBUCKET_BUILD_NUMBER","HEROKU_TEST_RUN_ID","VERCEL","NETLIFY"];function g(a){let b=new Headers;return a.nodeVersion&&b.set("Clerk-Node-Version",a.nodeVersion),a.nextVersion&&b.set("Clerk-Next-Version",a.nextVersion),a.npmConfigUserAgent&&b.set("Clerk-NPM-Config-User-Agent",a.npmConfigUserAgent),a.userAgent&&b.set("Clerk-Client-User-Agent",a.userAgent),a.port&&b.set("Clerk-Node-Port",a.port),a.host&&b.set("Clerk-Client-Host",a.host),a.xPort&&b.set("Clerk-X-Port",a.xPort),a.xHost&&b.set("Clerk-X-Host",a.xHost),a.xProtocol&&b.set("Clerk-X-Protocol",a.xProtocol),a.xClerkAuthStatus&&b.set("Clerk-Auth-Status",a.xClerkAuthStatus),a.isCI&&b.set("Clerk-Is-CI","true"),b}(0,d.ensureServerEntryExports)([e,g]),(0,b.registerServerReference)(e,"7f3834f3eb08a3ca5ed779190675911e2deecd55d6",null),(0,b.registerServerReference)(g,"7ff8b6724a6283bb8bcfc30895b089f14b31bf7742",null)}];

//# sourceMappingURL=node_modules_3b1d719d._.js.map