...
export default function FollowerOrdersPage() {
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-[var(--foreground-secondary)]">
                View and manage your copy trading orders
              </p>
            </div>
        ...
        <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
          <p className="text-blue-700 dark:text-blue-400 text-sm">
            <strong>Note:</strong> These orders are automatically created by the copy trading engine based on your followed leaders. You can cancel open orders, but you cannot replace them as a follower.
          </p>
        </div>
